...
export const EMPLOYER_ICON_NAV = [
  ...
  // { id: 'messages', icon: MessageSquare, label: 'Messages', href: '/employer/messages' }, // HIDDEN — feature disabled
...
export const CANDIDATE_ICON_NAV = [
  ...
  // { id: 'messages', icon: MessageSquare, label: 'Messages', href: '/candidate/messages' }, // HIDDEN — feature disabled
